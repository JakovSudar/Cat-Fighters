<?php
//populator za ubacivanje macaka u html
require_once "./populator.php";
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-2 d-flex flex-column align-items-center">
            ...
            <a id="addNew" href="./add.html"  class="btn btn-success">Add fighter! </a>
        </div>
